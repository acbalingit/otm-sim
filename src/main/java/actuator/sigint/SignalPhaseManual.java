...
public class SignalPhaseManual {
    public long id;
    public ActuatorSignalManual my_signal;
    public Set<RoadConnection> road_connections;

    private float signalFlowRate = 0.5f;

    public SignalPhaseManual(Scenario scenario, AbstractActuator actuator, jaxb.Phase jaxb_phase) throws OTMException {
        this.id = jaxb_phase.getId();
        this.my_signal = (ActuatorSignalManual) actuator;
